...
.. argparse::
    ...
    process writes them. ``--access`` selects the :term:`access class`, one
    value per :term:`access regime`; see :ref:`How to browse HDF5 data ?` for
    what each of them does and for building another combination.
